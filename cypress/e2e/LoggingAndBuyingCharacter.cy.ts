...
describe('Phaser App E2E Tests', () => {
    ...
    it('should log in and navigate to the Store scene, buy an upgrade', () => {
        ...
        cy.intercept('GET', 'https://rutold.onrender.com/:10000/gameData/characters')
        cy.intercept('GET', 'https://rutold.onrender.com/:10000/User/characters/*/*')
            
        cy.wait(1000)

        cy.get('canvas').then(($canvas) => {
            
            cy.intercept('POST', 'https://rutold.onrender.com/:10000/User/*/characters/*').as('buyUpgrade');
